...
% TODO: opening statement on why probabilities and non-determinism are important
\begin{abstract}
...
% TODO: short intro on MDPs with references to the literature, why they are
% important
% TODO: turn the door into an actual door

MDPs have been used to solve a wide range of problems: optimising airline yield
management \cite{DBLP:journals/transci/LautenbacherS99}, constructing optimal
dialogue strategies \cite{658989,DBLP:conf/icassp/LevinPE98}, electricity supply
bidding \cite{867150}, and many others.
...
% TODO: minimal example with a diagram
...
% TODO: mention we will be using bigraphs with sharing and we recall some
% definitions from TCS paper
...
% TODO: for the same D_i - not clear
% TODO: minimal example showing normalisation
...
% TODO: D_i not clear
% TODO: different symbol for reward
...
% TODO: minimal example, possible the same one as below

\section{Implementation}

% TODO: we extend BigraphER
% TODO: describe the new syntactical constructs using the example
% TODO: what's the reward of action b?
...
% TODO: the agent is simply modelled as an atomic node as the focus of this case
% study is on its movements across a grid. More complex models are possible
% by...
...
% TODO: taking advantage of the hierarchical structure of bigraphs
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \draw (1.75, 2) -- (2, 2);
  \end{tikzpicture}
  \caption{The full map. The agent is in the top left cell. There is a thick
    brown door connecting the middle cell of the top row with a $2 \times 2$
    room below. The red dashed wall exists with probability $1-p$.}
  \label{agent2_map}
\end{figure}
...
% TODO: limitation of a single entrance/exit per cell, can a room have multiple
% doors (doesn't make sense for this conceptualisation of the problem)?

% TODO: state diagrams (and statistics about them)
% TODO: numerical analysis (or ideas)
% TODO: discussion section
% TODO: what are the adtantages of using NBRS?
% TODO: limitations
% TODO: difficulties
...
% Extensions: multiple agents (nice), uncertainty in actions (easy), rotations
% (pomdp paper, easy), not limited to four directions
