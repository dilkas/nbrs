...
\begin{definition}[solid bigraph] \label{solid}
...
label=agent1_controls, firstline=3, lastline=14]{models/agent1/agent.big}
...
lastline=30]{models/agent1/agent.big}
...
lastline=117]{models/agent1/agent.big}
...
firstline=186, lastline=189]{models/agent1/agent.big}
...
firstline=16, lastline=20]{models/agent2/agent.big}
...
firstline=22, lastline=49]{models/agent2/agent.big}

\lstinputlisting[caption={The action of going north.}, captionpos=b,
language=Big, label=agent2_north, firstline=67,
lastline=76]{models/agent2/agent.big}
...
% TODO: code for representing the map
% TODO: what if a door to a room is locked (don't remove the room itself)
