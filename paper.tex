...
\subsection{Exporting to PRISM}

% TODO: need to cite something about the syntax, logic, etc.
Now that we have two models defined in BigraphER, we will briefly show how they
can be exported and used for quantitative analysis with PRISM.
...
reader is welcome to check that the numbers are as expected.
