...
\title[Nondeterministic Bigraphs]{Nondeterministic Bigraphs and Their Use in Modelling Movement}
%s\subtitle{}
...
\begin{frame}{Entering/Leaving a Room}
  \lstinputlisting[language=Big, firstline=86,
  lastline=95]{../models/agent2/agent.big}
\end{frame}
...
%      \end{itemize}
%    \item Discovered space = inner space (the room)
%    \end{itemize}
